...
def process_reticulate(df_events, df_locations, grid_size = 500, prob_0 = 0.7):
    #eventsFile = 'events_filtered.csv'
    #locationsFile = 'locations_for_multiple_providers_from_18-11-01_to_19-11-01.csv'
    #df_events = pd.read_csv(eventsFile)
    #df_locations = pd.read_csv(locationsFile)
    processor = DataProcessor(df_events, df_locations, grid_size, prob_0)
    return processor.process_data()

##if __name__ == '__main__':
##    eventsFile = '../../data_files/events_filtered.csv'
