...
def process_data(df_events, df_locations):
    ...
    # df_interval.to_csv('../../../data_files/20210120_intervalCountsLATLNG.csv', index=False)
    ...
    # save dataframes for testing purposes
    # df_pickup.to_csv('../../../data_files/20210120_pickupsLatLng.csv', index=False)
    print("Finished computing pickups data")
    df_demand = estimateDemand.estimate_demand(df_events, df_pickup, df_interval, start, end)
    # save dataframes for testing purposes
    # df_demand.to_csv('../../../data_files/20210120_demandLatLng.csv', index=False)
